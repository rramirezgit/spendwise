  ...
  return (
    <div className="px-5 pt-5 pb-28">
      <div className="rounded-3xl border border-amber-500/20 bg-amber-500/[0.06] p-6">
        <p className="text-xs font-medium tracking-widest text-amber-500/80 uppercase">Joint savings</p>
      ...
      {items.length === 0 ? (
        <div className="py-14 text-center">
          ...
          <p className="mt-3 text-sm text-zinc-500">No savings yet. Start your shared fund together.</p>
        </div>
      ) : (
      ...
      fields={
        <>
          <input
            ...
            placeholder="Note (e.g. Vacation fund)"
