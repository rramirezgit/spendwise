...
const en = {
  ...
  control_hint: 'Personal day-to-day spending — informational only.',
  no_daily: 'No daily expenses yet. Log a coffee, a burger, anything.',
  add_daily: 'Add expense',
  new_daily: 'Daily expense',
  daily_name_ph: 'What did you buy? (e.g. Burger)',
  // expense row / sheet
  who_pays: 'Who pays?',
  half_half: '½ Half & half',
...
const es: typeof en = {
  ...
  control_hint: 'Tus gastos del día a día — solo informativo.',
  no_daily: 'Aún no registraste gastos diarios. Anotá un café, una hamburguesa, lo que sea.',
  add_daily: 'Agregar gasto',
  new_daily: 'Gasto diario',
  daily_name_ph: '¿Qué compraste? (ej. Hamburguesa)',
  who_pays: '¿Quién paga?',
